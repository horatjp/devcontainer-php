...
```bash
mkdir -p php-develop
curl -L https://github.com/horatjp/devcontainer-php/archive/refs/tags/8.5.tar.gz | tar -xz --strip-components=1 -C php-develop
code php-develop
```
...
```bash
composer create-project --prefer-dist "laravel/laravel:13.*" /tmp/laravel
